  ...
  return (
    <div className='min-h-[80vh] md:min-h-[300px] w-full text-white'>
        ...
        <div className='md:flex justify-between lg:px-6 xl:px-20'>
            <div className='bg-[#1C222A] mb-[50px] w-full lg:w-[320px] md:w-[280px] rounded-2xl shadow-xl py-9 px-9 h-[340px] md:h-auto relative'>
            ...
            <div className='bg-[#1C222A] mb-[50px] w-full lg:w-[320px] md:w-[280px] md:mx-1 rounded-2xl shadow-xl py-9 px-9 h-[340px] md:h-auto relative'>
                <div className='text-[80px] md:text-[60px] text-[#88B8F4]'>
                    <DiIllustrator />
                </div>
                <div>
            ...
            <div className='bg-[#1C222A] mb-[50px] w-full lg:w-[320px] md:w-[280px] rounded-2xl shadow-xl py-9 relative px-9 h-[340px] md:h-auto'>
                <div className='text-[80px] md:text-[60px] text-[#88B8F4]'>
                    <DiLinux />
                </div>
                <div>

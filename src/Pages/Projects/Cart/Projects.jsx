...
const Projects = ({imgUrl,liveLink,repoLink,title}) => {
    ...
    return (
        <div className='bg-[#1C222A] mb-[50px] w-full md:w-[380px] rounded-2xl shadow-xl pb-5 px-5 mr-6'>
            ...
            <div className='w-full h-[30px] text-center text-white capitalize italic'>
